...
<head>
    <meta charset="utf-8" />
    <title>Login | Auto Lamaran</title>
                        ...
                        <div class="card mt-4 card-bg-fill">
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Masuk untuk mengelola lamaran kerja Anda.</p>
                                </div>
                                    ...
                                    <form action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('login') is-invalid @enderror"
                                                ...
                                                placeholder="Masukkan email atau nama Anda" required autofocus>
                                            @error('login')
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> Auto Lamaran.
                            </p>
                        </div>
                    </div>
                </div>
